...
Automatically generate a **REST API** and run any static site generator using [Prisma](https://www.prisma.io), [Express](https://expressjs.com), and [TypeScript](https://www.typescriptlang.org/).
