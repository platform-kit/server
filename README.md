...
Automatically generate a self-documenting **GraphQL** /  **REST API** from a [Prisma](https://www.prisma.io) schema.

Built with [Express](https://expressjs.com), [Apollo](https://www.apollographql.com), and [TypeScript](https://www.typescriptlang.org/).
...
If you're starting from scratch, add your prisma schema at `/app/prisma/schema.prisma`.
